...
/**
 * Created by vatsalpatel on 16-03-09.
 */
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY =  "com.example.vatsalpatel.fragment";
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://"+CONTENT_AUTHORITY);

    public static final String PATH_WEATHER = "weather";
    public static final String PATH_LOCATION = "location";

    static android.text.format.Time time = new android.text.format.Time();
    ...
    public static final class WeatherEntry implements BaseColumns{
        ...
        public static Uri buildWeatherLocation(String locationSetting){
            return ContentUris.withAppendedId(CONTENT_URI, Long.parseLong(locationSetting));
        }
        ...
        private static long normalizeDate(long startDate) {
            return time.setJulianDay(android.text.format.Time.getJulianDay(System.currentTimeMillis(), time.gmtoff));
        }
